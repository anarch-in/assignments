...
public static b4a.example.homeloan _homeloan = null;
  public Object[] GetGlobals() {
		return new Object[] {"CarLoan",Debug.moduleToString(b4a.example.carloan.class),"HomeLoan",Debug.moduleToString(b4a.example.homeloan.class),"Main",Debug.moduleToString(b4a.example.main.class),"Service",starter.mostCurrent._service};
}
}