...
public static b4a.example.homeloan _homeloan = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"btnCarLoan",main.mostCurrent._btncarloan,"btnHomeLoan",main.mostCurrent._btnhomeloan,"CarLoan",Debug.moduleToString(b4a.example.carloan.class),"HomeLoan",Debug.moduleToString(b4a.example.homeloan.class),"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}